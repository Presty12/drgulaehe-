...
exports.run = (client, message, args) => {
        ...
        if(!message.member.roles.cache.has("759441120077152296")) return message.channel.send('Bunu kullanamazsınız!')
        if(!message.guild.me.roles.cache.has("759441120077152296")) return message.channel.send('Doğru izinlere sahip değilim.') 
